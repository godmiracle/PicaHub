...
- [ ] 4.1 Implement a Keychain-backed token store and tests for save, restore, delete, and unavailable-Keychain errors
...
- [ ] 5.1 Implement the category repository and category screen with loading, content, empty, error, retry, and refresh states
...
- [ ] 6.1 Implement chapter image pagination with bounded concurrency, deterministic ordering, cancellation, and duplicate prevention
